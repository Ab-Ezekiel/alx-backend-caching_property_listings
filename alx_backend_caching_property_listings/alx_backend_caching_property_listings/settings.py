...
SECRET_KEY = 'django-insecure-#ibbz@!dna#grhmb-!27v+ewm^p1ig$bx(yk3^vfriar-_^ozw'
...
DATABASES = {
    'default': {
        ...
        # If Django runs in Docker compose, host is the service name "db"
...
# Optionally enable cache for sessions
